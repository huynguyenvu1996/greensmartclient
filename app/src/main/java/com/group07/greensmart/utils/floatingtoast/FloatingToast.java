...
public class FloatingToast {
    ...
    private SquaredViewCustom icon;
    private TextView title, subtitleText;
    private int initialSize;
    private Drawable backgroundDrawable;
    private FloatingToast achievementUnlocked;

    public FloatingToast(Context context, ViewGroup parentView) {
    ...
    public FloatingToast setBackgroundColor(int backgroundColor) {
    ...
    public FloatingToast setIconBG(int iconBG) {
        this.iconBG = iconBG;
        return this;
    ...
    public FloatingToast setTitleColor(int titleColor) {
    ...
    public FloatingToast setSubtitleColor(int subtitleColor) {
    ...
    public FloatingToast setDuration(int timeInMilliseconds) {
    ...
    public FloatingToast setBackgroundDrawable(Drawable backgroundDrawable) {
    ...
    @TargetApi(21)
    public FloatingToast setElevation(float elevation) {
        this.elevation = elevation;
        return this;

    }

    public FloatingToast isLarge(boolean large) {
        this.large = large;
        return this;

    }

    public FloatingToast alignTop(boolean alignTop) {
    ...
    public FloatingToast setIcon(Drawable icon) {
    ...
    public FloatingToast setTitle(CharSequence title) {
    ...
    public FloatingToast setTitle(String title) {
        this.titleString = title;
        return this;

    }

    public FloatingToast setSubTitle(String subtitle) {
        this.subtitle = subtitle;
        return this;

    }

    public FloatingToast setTypeface(Typeface typeface) {
        this.typeface = typeface;
        return this;

    }

    public FloatingToast setTitle(int ResID) {
        this.titleString = context.getResources().getText(ResID).toString();
        return this;

    }

    public FloatingToast setSubTitle(int ResID) {
        this.subtitle = context.getResources().getText(ResID).toString();
        return this;
    }

    public FloatingToast setSubTitle(CharSequence subTitle) {
        this.subtitle = subTitle.toString();
        return this;
    }


    public FloatingToast isPersistent(boolean persistent) {
        this.persistent = persistent;
        return this;
    }


    public FloatingToast isRounded(boolean isRounded) {
        this.isRounded = isRounded;
        return this;
    }

    public FloatingToast setStartDelay(int timeInMilliseconds) {
        this.delay = timeInMilliseconds;
        return this;

    }

    public FloatingToast setYOffset(int yOffset) {
        this.delay = yOffset;
        return this;
    ...
    private void buildAchievement() {
        ...
        final ViewGroup view = (ViewGroup) inflater.inflate(R.layout.floating_toast_layout, null);
        float dimen;
...
//        windowManager = (WindowManager) context.getSystemService(context.WINDOW_SERVICE);
        ...
        icon = (SquaredViewCustom) view.findViewById(R.id.achievement_icon);
...
// *shrug emoji*
    ...
    public interface achievementListener {
        ...
        void onAchievementBeingCreated(FloatingToast achievement, boolean created);

        void onAchievementExpanding(FloatingToast achievement, boolean expanded);

        void onAchievementShrinking(FloatingToast achievement, boolean shrunken);

        void onAchievementBeingDestroyed(FloatingToast achievement, boolean destroyed);
    }
